              ...
              <div class="row justify-content-center pt-5">
                <div class="col-md-8">
                  <div class="card  d-flex justify-content-center mb-0">
                    <div class="card-body">
                      <h2 class="mt-3 mb-4"><?php esc_html_e( 'Select Registration', 'tutor-lms-courses-moderation' ); ?></h2>
                      <p class="cnf-mail mb-1">
                      <?php esc_html_e( 'We\'re sorry, but it seems like the admin hasn\'t selected a specific registration type for you. In order to proceed with the registration process, please choose the appropriate registration type from the available options on the registration page. Thank you for your cooperation.', 'tutor-lms-courses-moderation' ); ?>
                      </p>
                      <div class="d-inline-block w-100 mt-3">
                        <div class="form-group">
                          <select class="form-select fwp-select-registration-type-to-proceed" data-trigger name="metadata[contract_type]" data-userid="<?php echo esc_attr( $userInfo->ID ); ?>">
                            <option value="" selected><?php esc_html_e( 'Select A Registration Type', 'tutor-lms-courses-moderation' ); ?></option>
