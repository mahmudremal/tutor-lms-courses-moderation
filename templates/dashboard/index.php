...
if( empty( $user_profile ) || $user_profile == 0 ) {
  wp_die( __( 'You\'ve visited on an outdated link, or your link is no longer valid. We didn\'t idetify the user with this permalink. That\'s all we know', 'tutor-lms-courses-moderation' ), __( 'Link broken', 'tutor-lms-courses-moderation' ) );
}
if( $user_profile == 'me' ) {
...
if( is_wp_error( $userInfo ) || $errorHappens ) :
  ...
  wp_die( $errorHappens, __( 'Error Happens', 'tutor-lms-courses-moderation' ) );
else :
  ...
  add_filter( 'pre_get_document_title', function( $title ) {
    global $userInfo;
    $title = apply_filters( 'futurewordpress/project/system/getoption', 'dashboard-title', __( 'User Dashbord', 'tutor-lms-courses-moderation' ) );
    $title = str_replace( [
      '{username}', '{sitename}'
    ], [
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
              ...
              <ul class="d-flex nav nav-pills mb-0 text-center profile-tab nav-slider" data-toggle="slider-tab" id="profile-pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-profile" role="tab" aria-selected="true" tabindex="-1"><?php esc_html_e( 'Profile',   'tutor-lms-courses-moderation' ); ?></a>
                </li>
                <?php endif; ?>
                <?php if( in_array( 'archive', $allowedTabs ) ) : ?>
                <li class="nav-item" role="presentation">
                  <a class="nav-link active show" data-bs-toggle="tab" href="#profile-archive" role="tab" aria-selected="false"><?php esc_html_e( 'Submit Videos',   'tutor-lms-courses-moderation' ); ?></a>
                </li>
                <?php endif; ?>
                <?php if( in_array( 'payments', $allowedTabs ) ) : ?>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-payments" role="tab" aria-selected="false" tabindex="-1"><?php esc_html_e( 'Payments',   'tutor-lms-courses-moderation' ); ?></a>
                </li>
                <?php endif; ?>
                <?php if( in_array( 'settings', $allowedTabs ) ) : ?>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-settings" role="tab" aria-selected="false" tabindex="-1"><?php esc_html_e( 'Your Social Media Handles',   'tutor-lms-courses-moderation' ); ?></a>
                </li>
                <?php endif; ?>
                <?php if( in_array( 'contact', $allowedTabs ) && apply_filters( 'futurewordpress/project/system/isactive', 'social-contact' ) ) : ?>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-contact" role="tab" aria-selected="false" tabindex="-1"><?php esc_html_e( 'Contact us now!',   'tutor-lms-courses-moderation' ); ?></a>
                </li>
                <?php endif; ?>
              </ul>
              <a href="<?php echo wp_logout_url(); ?>" class="btn btn-soft-danger btn-logout-confirm nav-link nav nav-pills mb-0 text-center profile-tab nav-slider"><?php esc_html_e( 'Logout', 'tutor-lms-courses-moderation' ); ?></a>
            </div>
          </div>
        </div>
      </div>
      <?php include TUTOR_LMS_COURSES_MODERATION_SCRATCH_DIR_PATH . '/templates/dashboard/cards/notices.php'; ?>
      <div class="col-lg-3">
        <div class="card h-12">
          <div class="card-header">
          <div class="header-title">
            <h4 class="card-title"><?php esc_html_e( 'Overview',   'tutor-lms-courses-moderation' ); ?></h4>
          </div>
          </div>
          <div class="card-body">
            ...
            <div class="text-center m-auto">
              <h4><?php esc_html_e( 'Monthly Retainer', 'tutor-lms-courses-moderation' ); ?></h4>
            ...
            <p class="mt-4 text-center"><strong style="margin-right: 5px;"><?php esc_html_e( 'Joined:',   'tutor-lms-courses-moderation' ); ?></strong> <?php echo esc_html( wp_date( 'M d, Y', strtotime( $userInfo->data->user_registered ) ) ); ?></p>
            ...
            <p class="mt-4 text-center"><strong style="margin-right: 5px;"><?php esc_html_e( 'Next Retainer:',   'tutor-lms-courses-moderation' ); ?></strong> <?php echo esc_html( wp_date( 'M d, Y', (int) $subsc[ 'current_period_end' ] ) ); ?></p>
            <?php endif; ?>
            <div class="separator separator-dashed my-8"></div>
            <?php endif; ?>
            ...
            <ul class="list-inline m-0 p-0">
              ...
              <img src="<?php echo esc_url( TUTOR_LMS_COURSES_MODERATION_SCRATCH_BUILD_URI . '/icons/calendar-checklist-date-svgrepo-com.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border bg-soft-light img-fluid" loading="lazy">
                <div class="ms-3">
                  <a class="" href="<?php echo empty( $userInfo->meta->content_calendar ) ? esc_attr( 'javascript:void(0)' ) : esc_url( $userInfo->meta->content_calendar ); ?>" target="<?php echo esc_attr( empty( $userInfo->meta->content_calendar ) ? '_self' : '_blank' ); ?>">
                    <h5><?php esc_html_e( 'Content Calendar',   'tutor-lms-courses-moderation' ); ?></h5>
              ...
              <li class="d-flex mb-4 align-items-center">
                ...
                <img src="<?php echo esc_url( TUTOR_LMS_COURSES_MODERATION_SCRATCH_BUILD_URI . '/icons/bookshelf-svgrepo-com.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-soft-danger" loading="lazy">
                <div class="ms-3">
                  <a class="" href="<?php echo empty( $userInfo->meta->content_library ) ? esc_attr( 'javascript:void(0)' ) : esc_url( $userInfo->meta->content_library ); ?>" target="<?php echo esc_attr( empty( $userInfo->meta->content_library ) ? '_self' : '_blank' ); ?>">
                    <h5><?php esc_html_e( 'Content Library',   'tutor-lms-courses-moderation' ); ?></h5>
                    <!-- <p class="mb-0">Added 1 hour ago</p> -->
                  </a>
                </div>
              </li>
              ...
              <li class="d-flex mb-4 align-items-center position-relative">
                <img src="<?php echo esc_url( TUTOR_LMS_COURSES_MODERATION_SCRATCH_BUILD_URI . '/icons/contract-document-svgrepo-com.svg' ); ?>" data-img="<?php echo esc_url( TUTOR_LMS_COURSES_MODERATION_SCRATCH_BUILD_URI . '/icons/Information carousel_Monochromatic.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-soft-danger" loading="lazy">
                <?php if( $doc->document_status != 'signed' ) : ?>
                  <span class="badge border border-danger bg-danger" style="position: absolute;top: -10px;left: 30px;color: black;"><?php esc_html_e( 'Action Needed',   'tutor-lms-courses-moderation' ); ?></span>
                <?php endif; ?>
                <div class="ms-3">
                  <a class="" href="<?php echo esc_url( $doc->permalink ); ?>" target="_blank">
                    <h5><?php echo esc_html( ( $doc->document_status == 'signed' ) ? __( 'Document Signed',   'tutor-lms-courses-moderation' ) : __( 'Sign Document',   'tutor-lms-courses-moderation' ) ); ?></h5>
                    <!-- <p class="mb-0">Added 1 hour ago</p> -->
                  </a>
                </div>
              </li>
        ...
        <div class="card h-12 profile-content tab-content iq-tab-fade-up">
          ...
          <div id="profile-profile" class="tab-pane fade" role="tabpanel">
            ...
            <div class="card">
              <div class="card-header">
                <div class="header-title">
                  <h4 class="card-title"><?php echo esc_html( sprintf( __( 'About %s',   'tutor-lms-courses-moderation' ), $userInfo->data->display_name ) ); ?></h4>
                </div>
              </div>
              <div class="card-body">
                ...
                <div class="mt-2">
                  <h6 class="mb-1"><?php esc_html_e( 'Joined:',   'tutor-lms-courses-moderation' ); ?></h6>
                  <p> <?php echo esc_html( wp_date( 'M d, Y', strtotime( $userInfo->data->user_registered ) ) ); ?></p>
                </div>
                <div class="mt-2">
                <h6 class="mb-1"><?php esc_html_e( 'Lives:',   'tutor-lms-courses-moderation' ); ?></h6>
                ...
                <div class="mt-2">
                <h6 class="mb-1"><?php esc_html_e( 'Email:',   'tutor-lms-courses-moderation' ); ?></h6>
                ...
                <div class="mt-2">
                <h6 class="mb-1"><?php esc_html_e( 'Url:',   'tutor-lms-courses-moderation' ); ?></h6>
                ...
                <div class="mt-2">
                <h6 class="mb-1"><?php esc_html_e( 'Contact:',   'tutor-lms-courses-moderation' ); ?></h6>
          ...
          <div id="profile-archive" class="tab-pane fade active show" role="tabpanel">
            <div class="card">
              <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                  <h4 class="card-title"><?php esc_html_e( 'Client Raw Video Archive',   'tutor-lms-courses-moderation' ); ?></h4>
                </div>
              </div>
              <div class="card-body">
                <div class="border rounded mb-3 p-2">
                  <form id="the-raw-video-archive-upload" class="form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <select class="form-select form-select-lg form-select-solid mb-2" name="month" data-control="select2" data-placeholder="<?php esc_attr_e( 'Upload for...', 'tutor-lms-courses-moderation' ); ?>">
                      ...
                      <div class="col-md-6">
                        <select class="form-select form-select-lg form-select-solid mb-2" name="year" data-control="select2" data-placeholder="<?php esc_attr_e( 'Upload for...', 'tutor-lms-courses-moderation' ); ?>">
                      ...
                      <div class="com-md-12">
                        <button type="button" class="btn btn-light-primary fw-bold col-12 mt-3 submit-archive-files" data-config="<?php echo esc_attr( json_encode( [
                          'title' => __( 'A short title', 'tutor-lms-courses-moderation' ),
                          'text' => __( 'Choose a title for your monthly archive. To update your archive, simply re-upload your files and resubmit - the new files will replace the previous ones.', 'tutor-lms-courses-moderation' ),
                          'icon' => 'info',
                          'confirmButtonText' => __( 'Submit', 'tutor-lms-courses-moderation' ),
                          'input' => 'text',
                          'inputAttributes' => [
                            'autocapitalize' => 'off'
                          ],
                        ...
                        ] ) ); ?>" role="button"><?php esc_html_e( 'Submit & Upload', 'tutor-lms-courses-moderation' ); ?></button>
                      </div>
                    </div>
                  </form>
                </div>
                ...
                <div class="<?php echo esc_attr( ( count( $archives ) > 0 ) ? 'custom-table-effect' : '' ); ?> table-responsive  border rounded">
                  <table class="table mb-0 fwp-datatable-field" data-toggle="data-table">
                    <thead>
                      <tr class="bg-white">
                        <th scope="col"><?php esc_html_e( 'Uploaded time',   'tutor-lms-courses-moderation' ); ?></th>
                        <th scope="col"><?php esc_html_e( 'Attached title',   'tutor-lms-courses-moderation' ); ?></th>
                        <th scope="col"><?php esc_html_e( 'Download',   'tutor-lms-courses-moderation' ); ?></th>
                      </tr>
                    </thead>
                    <tbody>
                    <?php if( count( $archives ) <= 0 ) : ?>
                        <tr>
                          <td colspan="3"><img src="<?php echo esc_url( TUTOR_LMS_COURSES_MODERATION_SCRATCH_BUILD_URI . '/icons/undraw_file_bundle_re_6q1e.svg' ); ?>" alt="<?php esc_attr_e( 'No Archives',   'tutor-lms-courses-moderation' ); ?>"></td>
                        </tr>
                      <?php else : ?>
          ...
          <div id="profile-payments" class="tab-pane fade" role="tabpanel">
            ...
            <?php if( false && apply_filters( 'futurewordpress/project/system/isactive', 'stripe-cancelsubscription' ) ) : ?>
              <div class="col-lg-6 col-md-6">
                <div class="card text-center">
                  <div class="card-body payment-page-card">
                    <h3 class=""><?php esc_html_e( 'Pause Subscription',   'tutor-lms-courses-moderation' ); ?></h3>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="card text-center">
                  <div class="card-body payment-page-card">
                    <h3 class=""><?php esc_html_e( 'Subscription',   'tutor-lms-courses-moderation' ); ?></h3>
                    ...
                    ] ) ); ?>" data-userid="<?php echo esc_html( $userInfo->ID ); ?>"><?php esc_html_e( 'Cancel', 'tutor-lms-courses-moderation' ); ?></button>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between">
                <div class="header-title pause-unpause-subscription-wrap">
                  <h4 class="card-title"><?php esc_html_e( 'Payment History',   'tutor-lms-courses-moderation' ); ?></h4>
                  ...
                  <?php if( ! apply_filters( 'futurewordpress/project/system/isactive', 'stripe-cancelsubscription' ) ) : ?>
                    <?php
                      ...
                      $config = [
                        'popup_title'       => __( 'Enter payment card details', 'tutor-lms-courses-moderation' ),
                        'card_number'       => __( 'Card Number:', 'tutor-lms-courses-moderation' ),
                        'expire_month'      => __( 'Expiration month:', 'tutor-lms-courses-moderation' ),
                        'expire_year'       => __( 'Expiration year:', 'tutor-lms-courses-moderation' ),
                        'card_ccv'          => __( 'CVC:', 'tutor-lms-courses-moderation' ),
                        'pls_fillall'       => __( 'Please fillup all fields first.', 'tutor-lms-courses-moderation' ),
                        'pls_fixwrngcdnm'   => __( 'Seems you\'ve inputed a wrong card number', 'tutor-lms-courses-moderation' ),
                        'pls_fillmonth'          => __( 'Please input Month in numeric format', 'tutor-lms-courses-moderation' ),
                        'pls_fixyear'          => __( 'Card expiration year should be future date.', 'tutor-lms-courses-moderation' ),
                        'pls_fixccv'          => __( 'Please provide valid CVC number.', 'tutor-lms-courses-moderation' ),
                      ];
                    ?>
                    <div class="btn-group btn-group-sm">
                      <button class="btn btn-soft-success border-active change-payment-card" type="button" role="button" name="change-payment-card" data-config="<?php echo esc_attr( json_encode( $config ) ); ?>" data-userid="<?php echo esc_attr( $userInfo->ID ); ?>"><?php esc_html_e( 'Change Payment Card',   'tutor-lms-courses-moderation' ); ?></button>
                      <button class="pause-unpause-subscription btn <?php echo esc_attr( $is_pending ? 'btn-light' : ( $is_active ? 'btn-outline-warning border-active' : 'btn-primary' ) ); ?>" type="button" role="button" name="meta-enable_subscription" data-current="<?php echo esc_attr( $is_active ? ( ( $dida_pause && $is_active ) ? 'pending' : 'pause' ) : 'unpause' ); ?>" data-pause-title="<?php esc_attr_e( 'Pause My Retainer', 'tutor-lms-courses-moderation' ); ?>" data-unpause-title="<?php esc_attr_e( 'Resume My Retainer', 'tutor-lms-courses-moderation' ); ?>" data-pending-title="<?php esc_attr_e( 'Pending', 'tutor-lms-courses-moderation' ); ?>" <?php echo esc_attr( $is_pending ? 'data-handled=true disabled' : '' ); ?>>
                        <?php echo esc_html( $is_pending ? __( 'Pending', 'tutor-lms-courses-moderation' ) : ( $is_active ? __( 'Pause My Retainer', 'tutor-lms-courses-moderation' ) : __( 'Resume My Retainer', 'tutor-lms-courses-moderation' ) ) ); ?>
                      </button>
                    </div>
                    <?php endif; ?>
                </div>
              ...
              <div class="card-body">
                ...
                <div class="<?php echo esc_attr( ( count( $payments[ 'data' ] ) > 0 ) ? 'custom-table-effect' : '' ); ?> table-responsive  border rounded">
                  <table class="table mb-0 fwp-datatable-field" data-toggle="data-table">
                    <thead>
                      <tr class="bg-white">
                        <th><?php esc_html_e( 'Name',   'tutor-lms-courses-moderation' ); ?></th>
                        <th><?php esc_html_e( 'Email',   'tutor-lms-courses-moderation' ); ?></th>
                        <th><?php esc_html_e( 'Date',   'tutor-lms-courses-moderation' ); ?></th>
                        <th><?php esc_html_e( 'Currency',   'tutor-lms-courses-moderation' ); ?></th>
                        <th><?php esc_html_e( 'Amount',   'tutor-lms-courses-moderation' ); ?></th>
                        <th><?php esc_html_e( 'Status',   'tutor-lms-courses-moderation' ); ?></th>
                        <th><?php esc_html_e( 'Invoice',   'tutor-lms-courses-moderation' ); ?></th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php if( count( $payments[ 'data' ] ) <= 0 ) : ?>
                        <tr>
                          <td colspan="7"><img src="<?php echo esc_url( TUTOR_LMS_COURSES_MODERATION_SCRATCH_BUILD_URI . '/icons/Card Payment_Monochromatic.svg' ); ?>" alt="<?php esc_attr_e( 'No Payments',   'tutor-lms-courses-moderation' ); ?>"></td>
                        </tr>
                      <?php else : ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo esc_html( ( $pay[ 'paid' ] ) ? __( 'Paid', 'tutor-lms-courses-moderation' ) : __( 'Unpaid', 'tutor-lms-courses-moderation' ) ); ?></td>
                          <td>
                            <div class="d-flex justify-content-evenly">
          ...
          <div id="profile-settings" class="tab-pane fade" role="tabpanel">
            <div class="card">
              <div class="card-header">
                <div class="header-title">
                <h4 class="card-title"><?php esc_html_e( 'Profile Settings',   'tutor-lms-courses-moderation' ); ?></h4>
                </div>
              </div>
              <div class="card-body">
                <?php include TUTOR_LMS_COURSES_MODERATION_SCRATCH_DIR_PATH . '/templates/dashboard/cards/content.php'; ?>
              </div>
            </div>
          </div>
          <?php endif; ?>
          ...
          <div id="profile-contact" class="tab-pane fade" role="tabpanel">
            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                  <h4 class="card-title"><?php esc_html_e( 'Contact us now!',   'tutor-lms-courses-moderation' ); ?></h4>
                </div>
              </div>
              <div class="card-body">
                      ...
                      <a class="card-body" href="<?php echo esc_url( apply_filters( 'futurewordpress/project/system/getoption', 'social-telegram', false ) ); ?>" target="_blank">
                        <div class="d-block justify-content-between align-items-center">
                          ...
                          <div class="text-center mt-3">
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'Telegram',   'tutor-lms-courses-moderation' ); ?></h3>
                          </div>
                        </div>
                      </a>
                    </div>
                    ...
                    <div class="card bg-soft-warning">
                      <a class="card-body" href="<?php echo esc_url( apply_filters( 'futurewordpress/project/system/getoption', 'social-whatsapp', false ) ); ?>" target="_blank">
                        <div class="d-block justify-content-between align-items-center">
                          ...
                          <div class="text-center mt-3">
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'WhatsApp',   'tutor-lms-courses-moderation' ); ?></h3>
                          </div>
                        </div>
                      </a>
                    </div>
                    ...
                    <div class="card bg-soft-warning">
                      <a class="card-body" href="mailto:<?php echo esc_attr( apply_filters( 'futurewordpress/project/system/getoption', 'social-email', false ) ); ?>">
                        <div class="d-block justify-content-between align-items-center">
                          ...
                          <div class="text-center mt-3">
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'Email',   'tutor-lms-courses-moderation' ); ?></h3>
                          </div>
                        </div>
                      </a>
                    </div>
                  ...
                  <div class="col-lg-12 col-md-12">
                    <div class="card">
                      <a class="card-body" href="<?php echo esc_url( apply_filters( 'futurewordpress/project/system/getoption', 'social-contactus', false ) ); ?>" target="_blank">
                        <div class="d-block justify-content-between align-items-center">
                          <div class="rounded p-3 text-center">
                            <img src="<?php echo esc_url( TUTOR_LMS_COURSES_MODERATION_SCRATCH_BUILD_URI . '/icons/Team meeting_Monochromatic.svg' ); ?>" alt="Contact Us" height="" width="">
                          </div>
                          <div class="text-center mt-3">
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'Contact US',   'tutor-lms-courses-moderation' ); ?></h3>
                          </div>
                        </div>
                      </a>
                    </div>
...
<div class="d-flex flex-column flex-root">
  ...
  <div class="wrapper d-flex flex-column flex-row-fluid">
    ...
    <?php // include TUTOR_LMS_COURSES_MODERATION_SCRATCH_DIR_PATH . '/templates/dashboard/cards/toolbar.php'; ?>
    ...
    <?php // include TUTOR_LMS_COURSES_MODERATION_SCRATCH_DIR_PATH . '/templates/dashboard/cards/footer.php'; ?>
    
    </div>
  </div>

  <?php // include TUTOR_LMS_COURSES_MODERATION_SCRATCH_DIR_PATH . '/templates/dashboard/cards/sidebar.php'; ?>
