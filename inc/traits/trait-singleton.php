...
namespace FUTUREWORDPRESS_PROJECT_SCRATCH\Inc\Traits;
...
trait Singleton {
	...
	final public static function get_instance() {
		...
		if ( ! isset( $instance[ $called_class ] ) ) {
			...
			/**
			 * Dependent items can use the `TUTOR_LMS_COURSES_MODERATION_SCRATCH_singleton_init_{$called_class}` hook to execute code
			 */
			do_action( sprintf( 'TUTOR_LMS_COURSES_MODERATION_SCRATCH_singleton_init_%s', $called_class ) ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
