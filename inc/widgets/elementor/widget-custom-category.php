...
class Widgets_CustomCategory extends \Elementor\Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		wp_register_style( 'listivo-child-widgets', TUTOR_LMS_COURSES_MODERATION_SCRATCH_BUILD_CSS_URI . '/widgets.css', [], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, TUTOR_LMS_COURSES_MODERATION_SCRATCH_BUILD_CSS_DIR_PATH . '/widgets.css' ) );
		...
		wp_register_script( 'listivo-child-widgets', TUTOR_LMS_COURSES_MODERATION_SCRATCH_BUILD_JS_URI . '/widgets.js', [ 'swiper' ], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, TUTOR_LMS_COURSES_MODERATION_SCRATCH_BUILD_JS_DIR_PATH . '/widgets.js' ), true );

	}
tutor-lms-courses-moderation
	/**
...
tutor-lms-courses-moderation
		return __( 'Custom Category Slider', 'tutor-lms-courses-moderation' );
...
tutor-lms-courses-moderation
	 ...
	 * Used to determine where to display thetutor-lms-courses-moderationor.
...
tutor-lms-courses-moderation
	...
	public function get_categories() tutor-lms-courses-moderation
...
tutor-lms-courses-moderation
	...
	public function get_script_depends() tutor-lms-courses-moderation
...
tutor-lms-courses-moderation
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			'section_content',tutor-lms-courses-moderation

			array(

				'label' => __( 'Content', 'tutor-lms-courses-moderation' ),

			)

		);

		$this->add_control(tutor-lms-courses-moderation

			'show_view_all',tutor-lms-courses-moderation

			[

				'label' => esc_html__('Display "View All" button', 'tutor-lms-courses-moderation'),

				'type' => Controls_Manager::SWITCHER,tutor-lms-courses-moderation

				'return_value' => '1',tutor-lms-courses-moderation
		...
		$this->add_control(
			...
			[
tutor-lms-courses-moderation
				'label' => esc_html__('Style', 'tutor-lms-courses-moderation'),

				'type' => Controls_Manager::SELECT,

				'options' => [

					'left' => esc_html__('Left', 'tutor-lms-courses-moderation'),

					'right' => esc_html__('Right', 'tutor-lms-courses-moderation'),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'Heading Text', 'tutor-lms-courses-moderation' ),

				'type'    => Controls_Manager::TEXT,

				'default' => __( 'Heading Text', 'tutor-lms-courses-moderation' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('Show button', 'tutor-lms-courses-moderation'),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('View All Text', 'tutor-lms-courses-moderation'),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'Button Text', 'tutor-lms-courses-moderation' ),

				'type'    => Controls_Manager::TEXT,

				'default' => __( 'View all', 'tutor-lms-courses-moderation' ),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'View all button link', 'tutor-lms-courses-moderation' ),
		...
		$this->add_control(
				...
				[
						...
						'label' => esc_html__('Image', 'tutor-lms-courses-moderation'),
		...
		$this->start_controls_section(
			...
			array(
				...
				'label' => __( 'Slider', 'tutor-lms-courses-moderation' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Category Label', 'tutor-lms-courses-moderation'),

				'type' => Controls_Manager::TEXT,

				'placeholder' => __( 'Title Here', 'tutor-lms-courses-moderation' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Category URL', 'tutor-lms-courses-moderation'),

				'type' => Controls_Manager::TEXT,

				'placeholder' => __( 'Full URL of this category.', 'tutor-lms-courses-moderation' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Background Color', 'tutor-lms-courses-moderation'),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('Category Items', 'tutor-lms-courses-moderation'),
